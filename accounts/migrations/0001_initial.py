        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=120, unique=True, verbose_name="department name"
                    ),
                ),
                (
                    "code",
                    models.CharField(
                        help_text="Short code used in reports, e.g. IT or ADM.",
                        max_length=16,
                        unique=True,
                        verbose_name="code",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Roll number for students, staff ID for HOD and Admin.",
                        max_length=32,
                        null=True,
                        unique=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Snapshot of the actor, kept even if the account is removed.",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("COMPLAINT_UPDATED", "Complaint edited"),
                            ("STATUS_CHANGED", "Complaint status changed"),
                            ("COMPLAINT_ASSIGNED", "Complaint assigned"),
                            ("REMARK_ADDED", "Remark added"),
                            ("UNMASK", "Anonymous complaint unmasked"),
                            ("ACCESS_DENIED", "Unauthorised access attempt"),
